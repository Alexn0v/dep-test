...
DROPBOX_ACCESS_TOKEN = 'sl.BHOZKJcWjxcAXZYGiRfczCMSrvhcRyVJ-fAh0L2qV-gJSHHnhwBL9RK9wqy2Au5PN-D9Wg9qfyr8hWRMu8D_18B7xi3CJI-oN8p41WQryGnEShUJsJznkvZE0HhLaFYMzuiatBle5hfn'
...
def parse_all_data ():
	for i in range(0,len(MedRank_Leads)):
		...
		try:
			...
			print(e)
			MedRank_Leads.loc [i, 'Link'] = '0'
		else:
			image_directory,image_name = resize_image(image_directory,image_name)
			m,dropbox_file_path = dropbox_upload_file(image_directory,image_name,dropbox_file_path='/Automated/{}'.format(image_name))
#			time.sleep(5)
